/*
  # Fix user_id column types and handle all dependencies

  1. Drop all views that depend on user_id columns
  2. Drop all RLS policies 
  3. Drop foreign key constraints
  4. Create users table
  5. Alter user_id columns from uuid to text
  6. Recreate all policies with text user IDs
  7. Recreate views with updated column types
  8. Add foreign key constraints
  9. Add Clerk integration functions and triggers
*/
