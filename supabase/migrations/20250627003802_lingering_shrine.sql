/*
  ...
  This migration converts user_id columns from uuid to text across all tables to support Clerk authentication,
  recreates RLS policies, views, and foreign key constraints.

  ## Changes Made:
  1. Drop dependent views and RLS policies
