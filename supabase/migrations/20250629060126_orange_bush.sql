/*
  # Clerk Integration and Database Optimization
  ...
  2. Security
     - Create functions for JWT handling
     - Update RLS policies
...
BEGIN
  ...
  IF NOT EXISTS (
    ...
    -- Criar índice para is_active imediatamente
...
BEGIN
  IF NOT EXISTS (
    ...
    -- Criar índice para role imediatamente
    CREATE INDEX IF NOT EXISTS idx_users_role ON users(role);
  END IF;
END $$;

-- Adicionar last_sign_in_at e metadata separadamente
DO $$
BEGIN
  ...
  IF NOT EXISTS (
    ...
    -- Criar índice para last_sign_in_at imediatamente
