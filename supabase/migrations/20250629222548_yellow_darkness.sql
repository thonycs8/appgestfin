/*
  ...
  1. New Columns
    - Adds Clerk integration fields to users table
    - Adds role management and activity tracking
  
  2. Functions
    - Improved user ID extraction from JWT
...
-- Cada índice em um bloco separado para evitar falhas em cascata
DO $$
BEGIN
